            ...
            <div className="mx-4">
             {
              ...
              <Link className="btn btn-outline-primary" to="/register">
                ...
                <div className="header__content " style={{height: 35}} >
                ...
                <nav className="header__nav" style={{marginRight: 550}}>
                ...
                <form action="#" className="header__search">
                  <input type="text" placeholder="Artist, track or podcast"></input>
                ...
                <div className="header__actions">
                  ...
                  <div className="header__action header__action--note">
                    ...
                    <div className="header__drop">
                      ...
                      <div className="header__note header__note--succ">
                        ...
                        <p><a href="#modal-info2" className="open-modal">Payment #51</a> was successful!</p>
                      ...
                      <div className="header__note header__note--fail">
                        ...
                        <p><a href="#modal-info3" className="open-modal">Payment #50</a> failed!</p>
                      ...
                      <div className="header__note header__note--info">
                        ...
                        <p><a href="#modal-info4" className="open-modal">Example</a> of notification.</p>
                        <span>2 hours ago</span>
                      </div>
                      <div className="header__note header__note--gift">
                        ...
                        <p><a href="#modal-info5" className="open-modal">You have received a gift!</a></p>
                  ...
                  <div className="header__action header__action--signin">
                    <a className="header__action-btn" href="signin.html">
                    <a className="btn btn-outline-primary "  href="/" onClick={LogoutHanlder}>
                Logout
              </a>                    </a>
                  </div>
                </div>
